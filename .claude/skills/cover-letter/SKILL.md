...
# Basic Information
name: cover-letter
description: "Write compelling, personalized cover letters for job applications. Use whenever the user asks to write or improve a cover letter, including Korean requests for a 자기소개서 (self-introduction / cover letter)."
version: "1.0.0"
