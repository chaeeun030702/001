...
# Basic Information
name: resume-tailor
description: "Tailor and optimize a resume or CV for a specific job posting: match keywords, highlight relevant experience, and improve structure. Use whenever the user asks to write, improve, or tailor a resume or CV, including Korean requests for a 이력서 (resume)."
version: "1.0.0"
