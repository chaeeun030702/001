...
description: "Create clear, inclusive job postings and job descriptions with responsibilities, qualifications, and requirements. Use whenever the user asks to write a job description or job posting, including Korean requests for a 직무기술서 (job description)."
version: "1.0"
